...
export default function Home() {
    ...
    return (<div style={{backgroundImage:'url(src/Content/img/image.png)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
                <Typography variant='h4' sx={{ textAlign: 'center',fontFamily:'cursive' }} >Money Manager</Typography>
        <div style={{ width: '90%', paddingTop: '30px ', height: '530px', margin: '20px auto', borderRadius: '15px', boxShadow: ' rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px - 3px, rgba(0, 0, 0, 0.2) 0px - 3px 0px inset', overflowX: 'hidden' }} >
            <Box sx={{ display: 'flex', gap: '20px', justifyContent: 'space-between', padding: '10px 50px' }} >
                <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'relative', width: '40%', backgroundColor: 'transparant', height: '470px', borderRadius: '15px', boxShadow: ' rgb(204, 219, 232) 3px 3px 6px 0px inset, rgba(255, 255, 255, 0.5) -3px -3px 6px 1px inset' }} >
                    ...
                    <Box sx={{ width: '60%', height: '200px', backgroundColor: 'black', position: 'absolute', top: '20%', left: add ? '20%' : '-500px', transition: '.4s all', borderRadius: '20px', textAlign: 'center', paddingTop: '50px', boxShadow: ' rgba(255, 255, 255, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(255, 255, 255, 0.35) 0px -2px 6px 0px inset' }} >
                ...
                <Box sx={{ textAlign: 'center', width: '50%', backgroundColor: 'transparant', height: '470px', overflowY: 'scroll', '&::-webkit-scrollbar': { display: 'none' }, borderRadius: '15px', boxShadow: ' rgb(204, 219, 232) 3px 3px 6px 0px inset, rgba(255, 255, 255, 0.5) -3px -3px 6px 1px inset' }}>
